...
final class TypeParser
{
    ...
    /**
     * @var ?WeakMap<Namespace_, NameContext>
     */
    private static ?WeakMap $nameContexts = null;
    ...
    private static function resolveName(Node $n, Name $name): ?Name
    {
        ...
        self::$nameContexts ??= new WeakMap();

        if (! isset(self::$nameContexts[$ns])) {
            ...
            self::$nameContexts[$ns] = $nameCtx;
        }

        return self::$nameContexts[$ns]->getResolvedName($name, Use_::TYPE_NORMAL);
    }
